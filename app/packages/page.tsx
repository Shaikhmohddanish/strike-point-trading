    ...
    <div className="min-h-screen bg-black text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="bg-gradient-to-b from-slate-800 to-slate-900 border-slate-700 hover:border-gray-400 transition-all duration-300 overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-8">
                  <Button className="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-3" onClick={() => (window.location.href = "tel:+917738928016")}>
                    Click Here
                  </Button>
                </div>
              </CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="bg-gradient-to-b from-slate-800 to-slate-900 border-slate-700 hover:border-gray-400 transition-all duration-300">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-6">
                    <Button className="w-full bg-green-500 hover:bg-green-600 text-white text-sm py-2" onClick={() => (window.location.href = "tel:+917738928016")}>
                      Click Here
                    </Button>
                  </div>
                </CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-10">
              ...
              <Card className="bg-gradient-to-b from-slate-800 to-slate-900 border-slate-700 hover:border-gray-400 transition-all duration-300">
                ...
                <CardContent className="p-5">
                  ...
                  <div className="mt-4">
                    <Button className="w-full bg-green-500 hover:bg-green-600 text-white text-xs py-2" onClick={() => (window.location.href = "tel:+917738928016")}>
                      Click Here
                    </Button>
                  </div>
                </CardContent>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-teal-500 via-blue-500 to-purple-500 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" className="bg-white text-black hover:bg-gray-100 px-8 py-6 text-xl font-bold rounded-xl" onClick={() => (window.location.href = "tel:+917738928016")}>
            START FREE TRIAL
          </Button>
        </div>
      </section>
