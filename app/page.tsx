        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <InteractiveCard
              ...
              description="Craft and execute a solid trading plan to maximize your investment potential with Strike Point Trading expert guidance."
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="inline-flex items-center space-x-4 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3">
              ...
              <span className="text-lg font-bold">7738928016</span>
            </div>
          </div>
        </div>
      </section>
